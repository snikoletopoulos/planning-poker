...
export default function NewRoomPage() {
  ...
  const [stories, setStories] = useState<{ title: string; description: string }[]>([{ title: "", description: "" }])

  const addStory = () => {
    setStories([...stories, { title: "", description: "" }])
  }

  const updateStory = (index: number, field: "title" | "description", value: string) => {
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Set up your session and invite your team</CardDescription>
          </CardHeader>
          ...
          <CardFooter>
            <Button onClick={createRoom} className="w-full" disabled={!yourName.trim()}>
              Create Room
            </Button>
          </CardFooter>
        </Card>
